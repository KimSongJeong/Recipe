                ...
                <div class="col-12 col-lg-8">
                    <div class="blog-posts-area">
                        ...
                        <div class="single-blog-area mb-80">
                            ...
                            <!-- 건드려야 하는 곳 -->
                            <h4 class="test_font" style="font-size: 30px; margin-bottom: 30px;">이용 안내</h4>
                            <div style="color: black; text-align: left;">                                
                                <p style="color: black; text-align: center; font-size: 15px; font-family: 'allfonts';">
                                        <span style="font-weight: bold; font-size: 25px;">Dr.R</span>은 사용자 건강상태(질병)에 맞춰 식재료 및 레시피 추천 서비스를 제공하는 사이트 입니다 !
                                        <br>저희 서비스를 이용하시려면 <span style="color:darkgreen; font-weight: bold; font-size: 20px;">회원가입</span>을 먼저 진행해주세요 !!<br>
                                        회원가입을 하지 않으셔도 질병 맞춤 서비스를 <span style="color:brown; font-weight: bold; font-size: 20px;"> 질병 정보</span> 탭에서 사용하실 수 있습니다 !
                                        <br>
                                        맞춤 서비스 이외에도 제철 식재료 정보와 이를 사용한 레시피들도 다양하게 제공하고있습니다 !!!
                                    </p>
                            </div>
                        </div>
                    </div>
