...
ArrayList<FoodDTO> food = (ArrayList<FoodDTO>)session.getAttribute("go");
%>
...
<body style="font-family: 'allfonts'">
    ...
    <section class="small-receipe-area" >
        <div class="container">
            ...
            <div align="center" class="test_font" style="font-size: 25px; font-weight: bold;">
                <span style="color: brown;">고혈압<span style="color: black;">에 좋은 식재료예요 :D</span></span>
            </div>
