...
<%
	...
	ArrayList<FoodDTO> food = (ArrayList<FoodDTO>)session.getAttribute("dang");
%>
    <!DOCTYPE html>
<html lang="en">
...
<body style="font-family: 'allfonts'">
    ...
    <section class="small-receipe-area" >
        <div class="container">
            ...
            <div align="center" class="test_font" style="font-size: 25px; font-weight: bold;">
                <span style="color: brown;">당뇨<span style="color: black;">에 좋은 식재료예요 :D</span></span>
            </div>
