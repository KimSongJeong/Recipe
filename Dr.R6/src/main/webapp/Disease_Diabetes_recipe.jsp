...
<%
	...
	ArrayList<RecipeDTO> recipe = (ArrayList<RecipeDTO>)session.getAttribute("dang_recipe");
...
<body style="font-family: 'allfonts'">
    ...
    <div>
        <ul style="text-align: center;">
            <a class="test_font1" style="font-size: 17px; " href="Disease_Diabetes.jsp">정보</a>
            &nbsp&nbsp
            &nbsp&nbsp
            ...
            <a class="test_font1" style="font-size: 17px;border-bottom: 2px solid #adadad;" href="Disease_Diabetes_recipe.jsp">레시피</a>
        </ul>
    ...
    <section class="small-receipe-area" >
        <div class="container">
            ...
            <div align="center" class="test_font" style="font-size: 25px; font-weight: bold;">
                <span style="color: brown;">당뇨<span style="color: black;">에 좋은 요리예요 :D</span></span>
            </div>
