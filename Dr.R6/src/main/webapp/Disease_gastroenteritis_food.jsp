...
ArrayList<FoodDTO> food = (ArrayList<FoodDTO>)session.getAttribute("we");
%>    
...
<body style="font-family: 'allfonts'">
    ...
    <div>
        <ul style="text-align: center;">
            <a class="test_font1" style="font-size: 17px; " href="Disease_gastroenteritis.jsp">정보</a>
            &nbsp&nbsp
            &nbsp&nbsp
            
            <a class="test_font1" style="font-size: 17px;border-bottom: 2px solid #adadad; " href="Disease_gastroenteritis_food.jsp">식재료</a>
            &nbsp&nbsp
            &nbsp&nbsp
    ...
    <section class="small-receipe-area" >
        <div class="container">
            ...
            <div align="center" class="test_font" style="font-size: 25px; font-weight: bold;">
                <span style="color: brown;">위장병<span style="color: black;">에 좋은 식재료예요 :D</span></span>
            </div>
