...
ArrayList<RecipeDTO> recipe = (ArrayList<RecipeDTO>)session.getAttribute("we_recipe");	
%>
<!DOCTYPE html>
<html lang="en">
...
<body style="font-family: 'allfonts'">
	...
	<div>
        <ul style="text-align: center;">
            ...
            <a class="test_font1" style="font-size: 17px; border-bottom: 2px solid #adadad;" href="Disease_gastroenteritis_recipe.jsp">레시피</a>
        </ul>
			...
			<div class="col-12 col-lg-8">
                ...
                <span>님의 건강에 맞춰 음식을 추천해드려요!</span>
								...
								<div align="center" class="test_font"
									...
									<span style="color: brown;">위장병<span
